...
class AddHelperScreen extends ConsumerStatefulWidget {
  const AddHelperScreen({super.key});

  @override
  ConsumerState<AddHelperScreen> createState() => _AddHelperScreenState();
}

class _AddHelperScreenState extends ConsumerState<AddHelperScreen> {
  final _formKey = GlobalKey<FormState>();
  final _nameController = TextEditingController();
  final _phoneController = TextEditingController();
  final _notesController = TextEditingController();
  final _assignedFlatsController = TextEditingController();
  ...
  Future<void> _submitForm() async {
    ...
    try {
      await ref.read(helpersNotifierProvider.notifier).createHelper(helper);
      
      if (!mounted) return;

      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('Helper added successfully'),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Error adding helper: ${e.toString()}'),
