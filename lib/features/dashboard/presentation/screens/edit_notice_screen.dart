...
class EditNoticeScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EditNoticeScreen> createState() => _EditNoticeScreenState();
}
...
class _EditNoticeScreenState extends ConsumerState<EditNoticeScreen> {
  ...
  void initState() {
    ...
    _noticeDate = widget.notice.date;
  }
  ...
  Future<void> _submitForm() async {
    ...
    final updatedNotice = NoticeModel(
      ...
      author: widget.notice.author,
      isArchived: widget.notice.isArchived,
      createdAt: widget.notice.createdAt,
      updatedAt: DateTime.now(),
    );

    try {
      await ref.read(noticesNotifierProvider.notifier).updateNotice(updatedNotice);
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Error updating notice: ${e.toString()}'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Edit Notice', style: AppTextStyles.h2),
      ),
